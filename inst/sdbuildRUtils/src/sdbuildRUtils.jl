...
using .custom_func: is_function_or_interp, itp, ramp, make_step, pulse, seasonal, IM_round, logit, expit, logistic, nonnegative, rbool, rdist, indexof, IM_contains, substr_i, IM_filter, round_, ⊕
