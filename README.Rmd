...
sdbuildR offers two simulation engines: R and Julia. If you would like to run ensemble simulations, use units and implement delay functions, you will need to set up the Julia environment. Run `use_julia()` to install Julia and required packages (initial setup may take 5–15 minutes):
