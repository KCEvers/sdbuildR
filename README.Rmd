...
* `vignette("julia-setup")` Install and set up the Julia environment for running ensemble simulations and using units.
...
sdbuildR offers two simulation engines: R and Julia (supported by [JuliaConnectoR](https://github.com/stefan-m-lenz/JuliaConnectoR/)). If you would like to run ensemble simulations and use units, you will need to install and set up the Julia environment. Follow the guide at `vignette("julia-setup")`.
