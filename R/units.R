...
#' Specify unit in equation
#'
#' To use units in equations, enclose them in `u()`. Note that units are only supported in Julia, not in R.
#'
#' @param unit_str Unit string; e.g. '3seconds'
#'
...
#'
#' In rare cases, it may be desirable to drop the units of a variable within an equation. Use `drop_unit()` to render a variable unitless. Note that units are only supported in Julia, not in R.
#'
...
#'
#' In rare cases, it may be desirable to change the units of a variable within an equation. Use `convert_u()` to convert a variable to another matching unit. Note that units are only supported in Julia, not in R.
#'
#' @param x Variable
