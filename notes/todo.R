...
# *make note not all caps lock in units
# *pulse ramp step functions, not just for insightmaker_to_sfm but also for users in xmile()
# ** search for delay in https://github.com/scottfr/simulation/blob/bc51ea795ae3fda1885c1ab710cb99957ae51939/src/Modeler.js#L2196 to find difference between delayN and smoothN
# need to identify defined variables also so detect_undefined_var works with the macros + the ones in global script
#
...
##### EXTRAS #####
# - capacity
# - recognize vectorized models "https://insightmaker.com/insight/cH7FKRLiz1ZvQpYuhGwDE/3-K-rper-Problem-mit-Reibung"
# - make compatible with readsdr -> add function that writes script from readsdr output!
