...
computed variables are *Auxiliaries*, and any user-defined
linear interpolation functions are *Graphical Functions*
(also called converters, or table or lookup functions).
