...
```{r}
sfm = build(sfm, "coffee_temperature", "stock", eqn = "100", 
...
```{r}
sfm = build(sfm, "coffee_amount", "aux", eqn = "250", 
...
```{r}
sfm = model_units(sfm, "quality", doc = "Quality of life; also known as utility") |>
