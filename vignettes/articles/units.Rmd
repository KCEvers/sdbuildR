...
We first specify the simulation time unit. Think of the time axis of your simulation plot - if it spans from 0 to 100, are these a hundred hours, days, years? The simulation time unit can be modified using `sim_specs()`. We also change the simulation engine to Julia.

```{r}
# Simulation time unit of a day
sfm = xmile() %>% sim_specs(time_units = "day", language = "Julia")
