...
If you would like to simulate with Julia, set up the Julia environment:

```{r}
sdbuildR_setup()
```

Otherwise, switch the simulation language to R:
...
<!--   build("back_to_normal", "flow", eqn = "work * necessary_sleep / sleep / u('month')", from = "work", units = "hours/day/month") %>% -->
