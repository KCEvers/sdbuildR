...
```{r}
sfm = sfm %>%
  build("aim_for_normal", change_name = "need_for_rest", 
...
<!--   build("normal_workday", "constant", eqn = 8) %>% -->
<!--   build("new_tasks", "flow", eqn = "work * work_growth", to = "work") %>% -->
<!--   build("work_growth", "constant", eqn = 1.5) %>% -->
<!--   build("need_for_rest", "flow", eqn = "work * necessary_sleep / sleep", from = "work") %>% -->
<!--   build("sleep", "stock", eqn = "necessary_sleep") %>% -->
<!--   build("necessary_sleep", "constant", eqn = 8) %>% -->
...
<!--   build("new_tasks", "flow", eqn = "work * work_growth", to = "work", units = "hours/day/week") %>% -->
