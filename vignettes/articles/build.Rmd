...
sfm = sfm %>% 
  ...
  build("work_breeds_work", "flow", eqn = "workload * pile_on", to = "workload") %>%
...
sfm = sfm %>%
  ...
  build("aim_for_normal", "flow", eqn = "workload - normal_workday", from = "workload")
...
<!--   build("sleep", "stock", eqn = "necessary_sleep") %>% -->
<!--   build("necessary_sleep", "constant", eqn = 8) %>% -->
<!--   # build("worry_about_work", "flow", eqn = "(work - normal_workday) * worry_factor * necessary_sleep / sleep", from = "sleep") %>% -->
<!--  build("worry_about_work", "flow", eqn = "work * worry_factor * necessary_sleep / sleep", from = "sleep") %>% -->
<!--   build("worry_factor", "constant", eqn = .5)  -->
...
<!--   build("worry_about_work", "flow", eqn = "(work - normal_workday) * worry_factor * necessary_sleep / sleep", from = "sleep", units = "hours/day/month") %>% -->
<!--  # build("worry_about_work", "flow", eqn = "work * worry_factor * necessary_sleep / sleep", from = "sleep") %>% -->
<!--   build("worry_factor", "constant", eqn = .5, units = "1/month")  -->
