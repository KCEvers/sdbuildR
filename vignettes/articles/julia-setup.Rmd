...
If both `Sys.which("julia")` and `Sys.getenv("JULIA_BINDIR")` return an empty string (`""`), you'll need to add Julia to your PATH. If the Julia installation can be found, you can skip to step 6.
